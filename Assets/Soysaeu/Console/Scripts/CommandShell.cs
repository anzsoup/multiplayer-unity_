...
namespace Soysaeu.Console
{
	...
	public class CommandShell
	{
		...
		public Dictionary<string, CommandInfo> Commands { get { return commands; } }
		public Dictionary<string, CommandArg> Variables { get { return variables; } }
			...
			foreach (var type in Assembly.GetExecutingAssembly().GetTypes())
			{
				foreach (var method in type.GetMethods(method_flags))
				{
					...
					if (methods_params.Length != 1 || methods_params[0].ParameterType != typeof(CommandArg[]))
					{
						...
						rejected_commands.Add(command_name.ToLower(), CommandFromParamInfo(methods_params, attribute.Help));
						continue;
					}
		...
		public void RunCommand(string line)
		{
			...
			while (remaining != "")
			{
				...
				if (argument.String != "")
				{
					...
					{
						string variable_name = argument.String.Substring(1).ToLower();
